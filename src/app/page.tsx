      ...
      <div className="bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 flex space-x-8 flex-shrink-0">
        <button
          ...
          className={`py-4 px-2 border-b-4 font-bold transition-all text-sm uppercase tracking-widest ${
            activeTab === "Session" ? "border-blue-600 text-blue-700" : "border-transparent text-gray-500 hover:text-gray-800"
          }`}
        >
          Draft Session
        </button>
        <button
          ...
          className={`py-4 px-2 border-b-4 font-bold transition-all text-sm uppercase tracking-widest ${
            activeTab === "Players" ? "border-blue-600 text-blue-700" : "border-transparent text-gray-500 hover:text-gray-800"
          }`}
        >
          Players
        </button>
        <button
          ...
          className={`py-4 px-2 border-b-4 font-bold transition-all text-sm uppercase tracking-widest ${
            activeTab === "Teams" ? "border-blue-600 text-blue-700" : "border-transparent text-gray-500 hover:text-gray-800"
          }`}
        >
          Teams Info
        </button>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex gap-6 items-center">
                          <span className={`px-3 py-1 uppercase text-[10px] font-black tracking-widest rounded border ${statusColor}`}>{statusText}</span>
                          <svg
